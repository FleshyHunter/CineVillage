...
const screeningApiRoutes = require("./routes/apiRoutes/screeningApiRoutes");
...
app.use("/api/screenings", screeningApiRoutes);
...
app.use("/bookings", requireAuth, bookingRoutes);
app.use("/promotions", requireAuth, promotionRoutes);
app.use("/addons", requireAuth, addOnRoutes);
